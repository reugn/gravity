...
public interface Matcher {
     ...
     * @return the number of the occurrences of a given pattern in the target string.
     */
     ...
     * @return the number of the occurrences of a given pattern in the target InputStream.
