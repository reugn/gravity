...
import io.github.reugn.gravity.util.LRUCache;
...
public class BMHMatcher extends BaseMatcher {
    ...
    private static final Map<String, SkipTable> cache = Collections.synchronizedMap(
            new LRUCache<>(maxLRUEntries)
    );

    private static class SkipTable {
        private final Map<Character, Integer> skip_table = new HashMap<>();
